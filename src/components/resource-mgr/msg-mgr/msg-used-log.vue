...
<div>
	<toolbar>
				...
				<el-table height="600" border stripe ref="table" :data="tableData" style="width: 100%">
					...
					<el-table-column resizable show-overflow-tooltip property="createBy" align="center" label="发送人" width="120" />
					<el-table-column resizable show-overflow-tooltip property="toPhone" align="center" label="接收手机" width="120" />
					<el-table-column resizable show-overflow-tooltip property="context" align="center" label="短信内容"  />
				</el-table>
